...
import io.anush.writer.DatabaseWriter;
...
public class DBConfiguration {
	...
	public MultiResourceItemReader<String> reader1() throws Exception {
		...
		resources = patternResolver.getResources(filePath + "C:\\Users\\anush\\SQLScripts/*_01.sql");
	...
	public MultiResourceItemReader<String> reader2() throws Exception {
		...
		DBConfiguration spd = new DBConfiguration();
	...
	public FlatFileItemReader<String> reader() throws Exception {
		...
		reader.setLineMapper(new RowMapper());
	...
	public Step step1() throws Exception {
		return stepBuilderFactory.get("step1").<String, String>chunk(3).reader(reader1()).writer(writer())
				.taskExecutor(taskExecutor()).build();
	}

	@Bean
	public Step step2() throws Exception {
		return stepBuilderFactory.get("step2").<String, String>chunk(3).reader(reader2()).writer(writer())
				.taskExecutor(taskExecutor()).build();
	}
}